            ...
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl">
                    ...
                    <div class="p-4 relative">
                        <a :href="route('app.monitoring.export-pdf', {id: monitoring.id})" type="button" @click="onExportPDF()" class="w-full text-purple-700 border border-purple-700 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                            <file-text-icon size="18" class="inline-block mr-4"/>
                    ...
                    <div class="bg-gray-50 relative p-7">
                        ...
                        <div v-if="menuForms[menuIndex] != null && menuForms[menuIndex] != undefined">
                            <div v-if="menuForms[menuIndex].name == 'general'" action="#">
                                ...
                                <div class="mt-6">
                                    <button type="submit" @click="submitGeneral" :disabled="is_loading" class="text-white w-full bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                            ...
                            <div v-if="menuForms[menuIndex].name == 'category'">
                                <div>
                                    <div v-if="inputs.category != null && inputs.category != undefined">
                                        <div v-for="(item, index) in inputs.category" :key="`category-form-${index}`" class="my-3">
                                            ...
                                            <div v-if="inputType(item.type)">
                                                    ...
                                                    <div class="fill-monitoring-data border-2 border-gray-300 bg-gray-100 rounded-lg p-4">
                                                        ...
                                                        <div class="flex gap-x-2 w-full">
                                                            ...
                                                            <div class="justify-self-stretch">
                                                                <input disabled readonly v-if="values.category[index]" placeholder="Apabila ada" v-model="values.category[index].string_value" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-purple-500 block w-full p-2.5">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <small v-if="item.description != null" v-html="item.description"></small>
                                                ...
                                                <div v-if="item.type == 'file'">
                                                    <a :href="route('app.value.download', {id: item.value_data[0].id})" role="button" v-if="item.value_data.length > 0" class="bg-white p-4 rounded-lg shadow-lg gap-x-4 relative" :class="{'flex gap-x-4': item.value_data[0].type_file != 'image'}">
                                                        <div>
                                                ...
                                                <div v-if="item.type == 'date'">
                                                    <div class="relative gap-4 flex fill-monitoring-data border-2 border-gray-300 bg-gray-100 rounded-lg p-4">
                                                        ...
                                                        <div>
                                                            <p class="text-lg font-semibold">{{ values.category[index].date_value != null && values.category[index].date_value != '' ? formatDate(values.category[index].date_value) : '-'  }}</p>
                                                        </div>
                                                    </div>
                                                    <small v-if="item.description != null" v-html="item.description"></small>
                                                </div>
                                                ...
                                                <div v-if="item.type == 'time'">
                                                    <div class="relative gap-4 flex fill-monitoring-data border-2 border-gray-300 bg-gray-100 rounded-lg p-4">
                                                        ...
                                                        <div>
                                                            <p class="text-lg font-semibold">{{ values.category[index].time_value != null && values.category[index].time_value != '' ? values.category[index].time_value : '-'  }}</p>
                                                        </div>
                                                    </div>
                                                    <small v-if="item.description != null" v-html="item.description"></small>
                                                </div>
                                        ...
                                        <button  @click="onSubmitInput('category')" type="button" :disabled="is_loading" class="text-white w-full bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                                            <span v-if="!loading_button">
                                                Selanjutnya
                                            </span>
                                            <span v-else>
                            ...
                            <div v-if="menuForms[menuIndex].name == 'object'">
                                <div>
                                    <div v-if="inputs.object != null && inputs.object != undefined">
                                            ...
                                            <div v-if="inputType(item.type)">
                                                ...
                                                <div v-if="item.type == 'checkbox'">
                                                    <div class="fill-monitoring-data border-2 border-gray-300 bg-gray-100 rounded-lg p-4">
                                                        ...
                                                        <div class="flex gap-x-2 w-full">
                                                            <div class="self-center"><span>Yang lain :</span></div>
                                                            <div class="justify-self-stretch">
                                                                <input disabled readonly v-if="values.object[index]" placeholder="Apabila ada" v-model="values.object[index].string_value" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-purple-500 block w-full p-2.5">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <small v-if="item.description != null" v-html="item.description"></small>
                                                ...
                                                <div v-if="item.type == 'date'">
                                                    <div class="relative gap-4 flex fill-monitoring-data border-2 border-gray-300 bg-gray-100 rounded-lg p-4">
                                                        ...
                                                        <div>
                                                            <p class="text-lg font-semibold">{{ values.object[index].date_value != null && values.object[index].date_value != '' ? formatDate(values.object[index].date_value) : '-'  }}</p>
                                                        </div>
                                                    </div>
                                                    <small v-if="item.description != null" v-html="item.description"></small>
                                                </div>
                                                ...
                                                <div v-if="item.type == 'time'">
                                                    <div class="relative gap-4 flex fill-monitoring-data border-2 border-gray-300 bg-gray-100 rounded-lg p-4">
                                                        ...
                                                        <div>
                                                            <p class="text-lg font-semibold">{{ values.object[index].time_value != null && values.object[index].time_value != '' ? values.object[index].time_value : '-'  }}</p>
                                                        </div>
                                                    </div>
                                                    <small v-if="item.description != null" v-html="item.description"></small>
                                                </div>
                                        ...
                                        <button type="submit" @click="onSubmitInput('object')" :disabled="is_loading" class="text-white w-full bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                                            <span v-if="!loading_button">
                                                Selanjutnya
                                            </span>
                                            <span v-else>
                                            ...
                                            <div v-if="inputType(item.type)">
                                                ...
                                                <div v-if="item.type == 'checkbox'">
                                                    <div class="fill-monitoring-data border-2 border-gray-300 bg-gray-100 rounded-lg p-4">
                                                        ...
                                                        <div class="flex gap-x-2 w-full">
                                                            <div class="self-center"><span>Yang lain :</span></div>
                                                            <div class="justify-self-stretch">
                                                                <input disabled readonly v-if="values.monitoring[index]" placeholder="Apabila ada" v-model="values.monitoring[index].string_value" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-purple-500 block w-full p-2.5">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <small v-if="item.description != null" v-html="item.description"></small>
                                                ...
                                                <div v-if="item.type == 'date'">
                                                    <div class="relative gap-4 flex fill-monitoring-data border-2 border-gray-300 bg-gray-100 rounded-lg p-4">
                                                        ...
                                                        <div>
                                                            <p class="text-lg font-semibold">{{ values.monitoring[index].date_value != null && values.monitoring[index].date_value != '' ? formatDate(values.monitoring[index].date_value) : '-'  }}</p>
                                                        </div>
                                                    </div>
                                                    <small v-if="item.description != null" v-html="item.description"></small>
                                                </div>
                                                ...
                                                <div v-if="item.type == 'time'">
                                                    <div class="relative gap-4 flex fill-monitoring-data border-2 border-gray-300 bg-gray-100 rounded-lg p-4">
                                                        ...
                                                        <div>
                                                            <p class="text-lg font-semibold">{{ values.monitoring[index].time_value != null && values.monitoring[index].time_value != '' ? values.monitoring[index].time_value : '-'  }}</p>
                                                        </div>
                                                    </div>
                                                    <small v-if="item.description != null" v-html="item.description"></small>
                                                </div>
                                    ...
                                    <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto self-center">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 max-h-96 overflow-y-auto space-y-4">
                                                ...
                                                <a v-if="optionModal.index != null" :href="route('app.image.download', { id: images[optionModal.index].id })" role="button" class="flex gap-x-4 w-full hover:bg-gray-50 p-2 rounded-lg">
                                                    <div class="flex h-12 w-12 rounded-lg bg-green-100 relative">
                                                        <edit-icon class="mx-auto text-green-600 self-center" size="24"/>
                                                    </div>
                                                    <div>
                                                        <p class="text-lg font-semi-bold text-gray-700 pt-2">Download Data</p>
                                                    </div>
                                                </a>
                                            </div>
                                            ...
                                            <form @submit.prevent="storeImage()" action="#">
                                                <div class="p-6 max-h-96 overflow-y-auto">
                                                    <div>
                                                        ...
                                                        <input readonly required name="name" id="name-image" v-model="formImage.label" type="text" placeholder="Masukkan label gambar" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md">
                                                    </div>
                                                    <div class="mt-6">
...
export default defineComponent({
    ...
    methods: {
        ...
        onDownloadImage() {
            this.$inertia.get(this.route('app.image.download', {
                id: this.images[this.optionModal.index].id
            }), {
                preserveState: true,
                preserveScroll: true,
