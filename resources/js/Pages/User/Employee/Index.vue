<template>
    <app-layout title="Employee-Manage">
        <template #header>
        ...
        <div class="py-12">
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">            
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl">
                                            ...
                                            <div v-if="formModal.mode == 'show'">
                                                <div class="p-6">
                                                    <div>
                                                        ...
                                                        <input required name="name" id="name-employee" v-model="form.name" type="text" placeholder="Masukkan nama employee" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md" readonly>
                                                    </div>
                                                    <div>
                                                        <label for="email-employee">Email</label>
                                                        <input required name="email" id="email-employee" v-model="form.email" type="email" placeholder="Masukkan email employee" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md" readonly>
                                                    </div>
                                                    <div>
                                                        <label for="phone_number-employee">No Telp</label>
                                                        <input required name="phone_number" id="phone_number-employee" v-model="form.phone_number" type="tel" placeholder="Masukkan nomor telepon" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md" readonly>
                                                    </div>
                                                    <div>
                                                        <label for="division-employee">Divisi</label>
                                                        <input required name="division" id="division-employee" v-model="form.division" type="text" placeholder="Masukkan nama divisi" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md" readonly>
                                                    </div>
                                                    <div>
                                                        <label for="branch-employee">Cabang</label>
                                                        <input required name="branch" id="branch-employee" v-model="form.branch" type="text" placeholder="Masukkan nama cabang" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md" readonly>
                                                    </div>
                                                    <div>
                                                        <label for="position-employee">Posisi</label>
                                                        <input required name="position" id="position-employee" v-model="form.position" type="text" placeholder="Masukkan posisi" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md" readonly>
                                                    </div>
                                                    <div>
                                                        <label for="proffesion-employee">Pekerjaan</label>
                                                        <input required name="profession" id="profession-employee" v-model="form.profession" type="text" placeholder="Masukkan nama pekerjaan" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div v-else>
                                                <div class="p-6">
                                                    <div>
                                                        <label for="name-employee">Nama Pegawai</label>
                                                        <input required name="name" id="name-employee" v-model="form.name" type="text" placeholder="Masukkan nama employee" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md">
                                                    </div>
                                                    <div>
                                                        <label for="email-employee">Email</label>
                                                        <input required name="email" id="email-employee" v-model="form.email" type="email" placeholder="Masukkan email employee" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md">
                                                    </div>
                                                    <div>
                                                        <label for="phone_number-employee">No Telp</label>
                                                        <input required name="phone_number" id="phone_number-employee" v-model="form.phone_number" type="tel" placeholder="Masukkan nomor telepon" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md">
                                                    </div>
                                                    <div>
                                                        <label for="division-employee">Divisi</label>
                                                        <input required name="division" id="division-employee" v-model="form.division" type="text" placeholder="Masukkan nama divisi" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md">
                                                    </div>
                                                    <div>
                                                        <label for="branch-employee">Cabang</label>
                                                        <input required name="branch" id="branch-employee" v-model="form.branch" type="text" placeholder="Masukkan nama cabang" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md">
                                                    </div>
                                                    <div>
                                                        <label for="position-employee">Posisi</label>
                                                        <input required name="position" id="position-employee" v-model="form.position" type="text" placeholder="Masukkan posisi" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md">
                                                    </div>
                                                    <div>
                                                        <label for="proffesion-employee">Pekerjaan</label>
                                                        <input required name="profession" id="profession-employee" v-model="form.profession" type="text" placeholder="Masukkan nama pekerjaan" class="mt-3 focus:ring-purple-500 focus:border-purple-500 block w-full pl-4 sm:text-sm border-gray-300 rounded-md">
                                                    </div>
                                                </div>
                    ...
                    <div class="mt-3 mb-4" v-for="(item, index) in employees" :key="`user-${index}`">
...
export default defineComponent({
    ...
    methods: {
        ...
        store() {
            if(this.formModal.mode == 'create') {
                ...
                this.form.transform(data => ({
                    ... data,
                    _method: 'PATCH'
                })).post(this.route('app.employee.update', { id: this.employees[this.optionModal.index].id }),
                {
                    onFinish: () => this.toggleFormModal(false),
                    onSuccess: (response) => {
                        this.onToast(response)
        ...
        deleteData() {
            this.$inertia.delete(this.route('app.employee.destroy', { id: this.employees[this.optionModal.index].id  }),
            {
        ...
        toggleFormModal(status, mode = 'create', indexId = null) {
            ...
            if(indexId != null) {
                ...
                this.form.email = this.employees[indexId].email
                this.form.phone_number = this.employees[indexId].phone_number
                this.form.division = this.employees[indexId].division
                this.form.branch = this.employees[indexId].branch
                this.form.position = this.employees[indexId].position
                this.form.profession = this.employees[indexId].profession
