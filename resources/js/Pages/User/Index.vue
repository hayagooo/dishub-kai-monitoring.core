                                        ...
                                        <div>
                                            <div class="p-6 max-h-96 overflow-y-auto space-y-4">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <select required :disabled="formModal.mode == 'show'" :readonly="formModal.mode == 'show'" id="level-select-in-modal" v-model="form.level" :class="{'bg-gray-100': formModal.mode == 'show'}" class="mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
