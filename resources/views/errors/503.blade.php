...
<head>
    ...
    <title>Proses tidak tersedia - SIMPKA</title>
  ...
  <div class="px-40 py-20 bg-white rounded-md shadow-xl">
    <div class="flex flex-col items-center">
      <h1 class="font-bold text-blue-600 text-9xl">
          <img src="{{ asset('images/no_internet.png') }}" width="260px" alt="not_found">
      </h1>

      <h6 class="mb-2 text-2xl font-bold text-center text-gray-800 md:text-3xl">
        <span class="text-purple-500">Oops!</span> Proses tidak tersedia
      </h6>

      <p class="mb-8 text-center text-gray-500 md:text-lg">
        Mohon maaf. Fitur proses ini tidak tersedia
      </p>
